...
class Data:
    def __init__(
        ...
        try:
            self.data = pd.read_csv('data/{}.csv'.format(self.data_name), index_col=0)
        ...
        data_frequency_list = {'year': 1, 'season': 2, 'month':3, 'day':4}
...
# 因為只是做為判斷是否有交易日
open_price = pd.read_csv('data/open_price.csv', index_col=0)
